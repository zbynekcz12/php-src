...
class Foo
{
    ...
    public static function read_static($n)
    {
        for ($i = 0; $i < $n; ++$i) {
            $x = self::$a;
        }
    ...
    public static function write_static($n)
    {
        for ($i = 0; $i < $n; ++$i) {
            self::$a = 0;
        }
    ...
    public static function isset_static($n)
    {
        for ($i = 0; $i < $n; ++$i) {
            $x = isset(self::$a);
        }
    ...
    public static function empty_static($n)
    {
        for ($i = 0; $i < $n; ++$i) {
            $x = empty(self::$a);
        }
    ...
    public static function call_static($n)
    {
        for ($i = 0; $i < $n; ++$i) {
            self::f();
        }
    ...
    public function assign_add_prop($n)
    {
        for ($i = 0; $i < $n; ++$i) {
            $this->b += 2;
        }
    ...
    public function pre_inc_prop($n)
    {
        for ($i = 0; $i < $n; ++$i) {
            ++$this->b;
        }
